...
public final class RxJavaCallAdapterFactory2 extends CallAdapter.Factory {
  ...
  private RxJavaCallAdapterFactory2(@Nullable Scheduler schedulerSubscribeOn,@Nullable Scheduler schedulerObserverOn, boolean isAsync) {
  ...
  public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
    ...
    if (isCompletable) {
      return new RxJavaCallAdapter2(Void.class, schedulerSubscribeOn,schedulerObserverOn, isAsync, false, true, false,false, true);
    }
    ...
    return new RxJavaCallAdapter2(responseType, schedulerSubscribeOn, schedulerObserverOn,isAsync, isResult, isBody, isPaging,isSingle,
        false);
  }
}
